...
import './services.css';
import petGroomingImage from '../../assets/pet-grooming.jpg';
        ...
        const fetchServices = async () => {
            try {
                ...
                const transformedData = response.data.map(provider => ({
                                    ...
                                    image: provider.service_photos?.[0] || provider.profile_photo || petGroomingImage,
        ...
        if (loading) {
            return (
                <div className="service-container">
                    ...
                    <p>Finding Grooming Services near you...</p>
                </div>
            );
        }
    ...
    return (
        <div className="service-container">
            ...
            <div 
                ...
                style={{ '--banner-image': `url(${petGroomingImage})` }}
            >
                <h2>Pet Grooming</h2>
                <p>Find professional groomers for your pets!</p>
            </div>
...
{/* Service Cards */}
            {filteredServices.length > 0 ? (
                ...
                <div className="no-services">
                    <p>No Grooming services found {searchQuery ? `for "${searchQuery}"` : 'in your area'}.</p>
                    {searchQuery && (
