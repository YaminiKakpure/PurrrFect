...
import './services.css';
import petTrainingImage from '../../assets/dog-trainer.jpg';
        ...
        const fetchServices = async () => {
            try {
                ...
                const transformedData = response.data.map(provider => ({
                                    ...
                                    image: provider.service_photos?.[0] || provider.profile_photo || petTrainingImage,
                ...
                setError('Failed to load training services. Please try again later.');
                setServices([]);
                setFilteredServices([]);
            } finally {
                setLoading(false);
    ...
    return (
        <div className="service-container">
            ...
            <div 
                ...
                style={{ '--banner-image': `url(${petTrainingImage})` }}
            >
                <h2>Pet Training</h2>
                <p>Find expert trainers for your pets!</p>
            </div>
            ...
            <div className="service-search-container">
                <div className="service-search-bar">
                    ...
                    <input 
                        type="text" 
                        placeholder="Search nearby trainers..." 
                        value={searchQuery}
            ...
            {filteredServices.length > 0 ? (
                ...
                <div className="no-services">
                    <p>No training services found {searchQuery ? `for "${searchQuery}"` : 'in your area'}.</p>
                    {searchQuery && (
