...
import './services.css';
import petHotelImage from '../../assets/pet hotels.jpg';
        ...
        const fetchServices = async () => {
            try {
                ...
                const transformedData = response.data.map(provider => ({
                                    ...
                                    image: provider.service_photos?.[0] || provider.profile_photo || petHotelImage,
                ...
                setError('Failed to load pet hotels. Please try again later.');
                setServices([]);
                setFilteredServices([]);
            } finally {
                setLoading(false);
        ...
        if (loading) {
            return (
                <div className="service-container">
                    ...
                    <p>Finding pet stays near you...</p>
                </div>
            );
        }
    ...
    return (
        <div className="service-container">
            ...
            <div 
                ...
                style={{ '--banner-image': `url(${petHotelImage})` }}
            >
                <h2>Pet Hotels</h2>
                <p>Find luxurious stays for your pets!</p>
            </div>
            ...
            {filteredServices.length > 0 ? (
                ...
                <div className="no-services">
                    <p>No pet stays services found {searchQuery ? `for "${searchQuery}"` : 'in your area'}.</p>
                    {searchQuery && (
